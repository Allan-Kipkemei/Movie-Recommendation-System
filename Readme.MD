...
## Folder structure
      ...
      ├── images/
      │ ├── images.png
      │ ├── Screenshot 2024-07-29 154035.png
      │ └── wordcloud.png
      ├── static/
      ├── .gitignore
      ├── app.py
      ├── Group PPT.Rec System.pdf
      ├── knn_pv
      ├── knn_pv.joblib
      ├── mainrecommender.ipynb
      ├── Readme.MD
      ├── recom_model.joblib
      └── Recommender.ipynb
...
- [Filmfusion Movie Recommender System](#filmfusion-movie-recommender-system)
  ...
  - [Streamlit to deploy our model](#streamlit-to-deploy-our-model)
